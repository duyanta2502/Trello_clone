export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Duyanta2502 Board',
    description: 'Test description of board',
    type: 'public', // 'private'
    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-02', 'card-id-01', 'card-id-03', 'card-id-05', 'card-id-05', 'card-id-06', 'card-id-04'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'https://c4.wallpaperflare.com/wallpaper/101/380/61/cat-animals-bokeh-cute-wallpaper-preview.jpg',
